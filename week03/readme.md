# Week 3 Node.js Assignment

## What I built
I created a simple Node.js program in `week03/` that prints an identification header, runtime information, environment configuration, and a JSON-formatted `appConfig` object.
